...
O sistema imunologico humano, é o sistema responsavel por proteger o corpo de antigenos como virus e bacterias. A producao de globulos brancos, nome dado as celulas que compoem o sistema imunologico, é originada por algumas cadeias proteicas presentes no antigeno. Desse modo, propoe-se utilizar um modelo de regressao logistica com o objetivo, a partir de determinadas caracteristicas de uma cadeia proteica, a mesma pode gerar uma resposta do sistema imunilogico.
...
print(paste("Dados Faltantes na validacao: ", any(is.na(valData))))
print(paste("Dados Faltantes no teste: ", any(is.na(testData))))
print(paste("Dados Faltantes no SARS: ", any(is.na(testData))))
```

Como pode ser observado, a base nao possuia nenhum dado faltante para nenhuma das partes.
