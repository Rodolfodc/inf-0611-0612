...
for(lambda in lambda_values) {
  ...
  cm_relative_train <- calculaMatrizConfusaoRelativa(cm)
  ...
  cm_relative_val <- calculaMatrizConfusaoRelativa(cm)
  ...
  cm_test_relative <- calculaMatrizConfusaoRelativa(cm)
  cm_test_relative
  i <- i+1
}
 baseline_train_tpr <- TPR(cm_train, trainData)
 baseline_val_tpr <- TPR(cm_val, valData)
 baseline_test_tpr <- TPR(cm_test, trainData)
 
 baseline_train_tnr <- TNR(cm_train, trainData)
 baseline_val_tnr <- TNR(cm_val, valData)
 baseline_test_npr <- TNR(cm_test, trainData)
